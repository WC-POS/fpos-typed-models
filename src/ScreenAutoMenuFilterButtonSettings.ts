...
@Index(
  'PK_ScreenAutoMenuFilterButtonSettings',
  ['screenAutoMenuFilterButtonSettingsId'],
  { unique: true }
)
@Entity('ScreenAutoMenuFilterButtonSettings', { schema: 'dbo' })
export class ScreenAutoMenuFilterButtonSettings {
  @Column('uniqueidentifier', {
    primary: true,
    name: 'ScreenAutoMenuFilterButtonSettingsID',
    default: () => 'newsequentialid()',
  })
  screenAutoMenuFilterButtonSettingsId!: string;
  ...
  @ManyToOne(
    ...
    (screenAutoMenuFilter) =>
      screenAutoMenuFilter.screenAutoMenuFilterButtonSettings,
    { onDelete: 'CASCADE', onUpdate: 'CASCADE' }
  )
  @JoinColumn([
    {
      name: 'ScreenAutoMenuFilterID',
      referencedColumnName: 'screenAutoMenuFilterId',
    },
  ])
  screenAutoMenuFilter!: ScreenAutoMenuFilter;
}
